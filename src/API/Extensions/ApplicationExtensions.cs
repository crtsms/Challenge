...
public static partial class Extensions
{
    ...
    {
        var connectionString = builder.Configuration.GetConnectionString("Employee") ?? "Data Source=Data/Employee.db";
        builder.Services.AddSqlite<EmployeeContext>(connectionString);
        builder.Services.AddMigration<EmployeeContext, EmployeeContextSeed>();
